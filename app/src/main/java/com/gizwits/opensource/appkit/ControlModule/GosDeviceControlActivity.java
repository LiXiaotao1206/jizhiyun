...
public class GosDeviceControlActivity extends GosControlModuleBaseActivity
	...
	private TextView tv_data_GS_PH;
	private TextView tv_data_GS_CC;
	private TextView tv_data_GS_O2;
	private TextView tv_data_LS_SC;
	private TextView tv_data_LS_pH;
	private TextView tv_data_LS_PO4;
	private TextView tv_data_BH_Na;
	private TextView tv_data_BH_CC;
	private TextView tv_data_GR_CC;
	private TextView tv_data_GR_Na;
	private TextView tv_data_GR_SiO2;
	private TextView tv_data_QJ_CC;
	private TextView tv_data_QJ_O2;
	private TextView tv_data_Q;
	...
	private void initView() {
		...
		tv_data_GS_PH = (TextView) findViewById(R.id.tv_data_GS_PH);
		tv_data_GS_CC = (TextView) findViewById(R.id.tv_data_GS_CC);
		tv_data_GS_O2 = (TextView) findViewById(R.id.tv_data_GS_O2);
		tv_data_LS_SC = (TextView) findViewById(R.id.tv_data_LS_SC);
		tv_data_LS_pH = (TextView) findViewById(R.id.tv_data_LS_pH);
		tv_data_LS_PO4 = (TextView) findViewById(R.id.tv_data_LS_PO4);
		tv_data_BH_Na = (TextView) findViewById(R.id.tv_data_BH_Na);
		tv_data_BH_CC = (TextView) findViewById(R.id.tv_data_BH_CC);
		tv_data_GR_CC = (TextView) findViewById(R.id.tv_data_GR_CC);
		tv_data_GR_Na = (TextView) findViewById(R.id.tv_data_GR_Na);
		tv_data_GR_SiO2 = (TextView) findViewById(R.id.tv_data_GR_SiO2);
		tv_data_QJ_CC = (TextView) findViewById(R.id.tv_data_QJ_CC);
		tv_data_QJ_O2 = (TextView) findViewById(R.id.tv_data_QJ_O2);
		tv_data_Q = (TextView) findViewById(R.id.tv_data_Q);
	}
	...
	protected void updateUI() {
		...
		tv_data_GS_PH.setText(data_GS_PH+"");
		tv_data_GS_CC.setText(data_GS_CC+"");
		tv_data_GS_O2.setText(data_GS_O2+"");
		tv_data_LS_SC.setText(data_LS_SC+"");
		tv_data_LS_pH.setText(data_LS_pH+"");
		tv_data_LS_PO4.setText(data_LS_PO4+"");
		tv_data_BH_Na.setText(data_BH_Na+"");
		tv_data_BH_CC.setText(data_BH_CC+"");
		tv_data_GR_CC.setText(data_GR_CC+"");
		tv_data_GR_Na.setText(data_GR_Na+"");
		tv_data_GR_SiO2.setText(data_GR_SiO2+"");
		tv_data_QJ_CC.setText(data_QJ_CC+"");
		tv_data_QJ_O2.setText(data_QJ_O2+"");
		tv_data_Q.setText(data_Q+"");
